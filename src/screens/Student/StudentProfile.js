            ...
            { 
                ...
                <ScrollView>
                    <View style={{paddingTop: 40, alignSelf: 'center'}}>
                        <Image
                            style={{width: windowWidth* .6, height: windowWidth*.5, resizeMode:'center', borderWidth:2}}
                            source={{uri: 'https://live.staticflickr.com/65535/50926836403_6883441350_c.jpg'}}
                        />
                    </View>
